...
def main() -> None:
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("artifacts/datasets/sim_readings"))
    parser.add_argument("--frames", type=int, default=16)
    parser.add_argument("--fps", type=int, default=20)
    args = parser.parse_args()

    jsonl_path, csv_path = simulate_readings(args.output_dir, args.frames, args.fps)
