...
void OpenArm::switch_control_mode_all(damiao_motor::Control_Mode_Code mode) {
    for (damiao_motor::DMDeviceCollection* device_collection : sub_dm_device_collections_) {
        device_collection->switch_control_mode_all(mode);
    }
}

void OpenArm::switch_control_mode_one(int i, damiao_motor::Control_Mode_Code mode) {
    for (damiao_motor::DMDeviceCollection* device_collection : sub_dm_device_collections_) {
        device_collection->switch_control_mode_one(i, mode);
    }
}
