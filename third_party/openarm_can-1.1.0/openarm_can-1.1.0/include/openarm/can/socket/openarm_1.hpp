...
public:
    ...
    void enable_all();
    void disable_all();
    void switch_control_mode_all(damiao_motor::Control_Mode_Code mode);
    void switch_control_mode_one(int i, damiao_motor::Control_Mode_Code mode);
    void set_zero_all();
    void refresh_all();
