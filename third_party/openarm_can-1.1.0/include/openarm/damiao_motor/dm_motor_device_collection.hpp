...
public:
    ...
    // Switch Control Mode
    void switch_control_mode_one(int i, Control_Mode_Code mode);
    void switch_control_mode_all(Control_Mode_Code mode);
    ...
    //Pos Vel control operations
    void pos_vel_control_one(int i, float pos, float vel);
    void pos_vel_control_all(const std::vector<std::pair<float, float>>& pos_vels);

    //Vel control operations
    void vel_control_one(int i, float vel);
    void vel_control_all(const std::vector<float>& vels);
